-- UPDATE core_config_data SET VALUE="https://localhost:8443/pub/" WHERE path IN ("web/unsecure/base_url", "web/secure/base_url", "web/secure/base_link_url");
...
-- INSERT INTO core_config_data (scope, scope_id, path, value) VALUES(DEFAULT, 0, "catalog/search/opensearch_index_prefix", "aquiform_");
